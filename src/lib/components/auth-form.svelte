      ...
      <form class="p-6 md:p-8" onsubmit={handleSubmit}>
        <div class="flex flex-col gap-6">
          ...
          <div class="grid grid-cols-3 gap-4">
            <Button variant="outline" type="button" class="w-full cursor-pointer" onclick={signInGithub}>
              <Github />
              <span class="sr-only">Login with Github</span>
            </Button>
            <Button variant="outline" type="button" class="w-full cursor-pointer" onclick={signInGoogle}>
            ...
            <Button variant="outline" type="button" class="w-full cursor-pointer" onclick={signInMicrosoft}>
              <svg
